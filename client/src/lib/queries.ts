...
export interface Account {
  ...
  // The ramp. `daily_cap` is the ceiling; these decide how much of it applies
  // today. See `effectiveCap` on the server.
  warmup_enabled: boolean; warmup_started_at: string | null; warmup_start_cap: number; warmup_step: number;
